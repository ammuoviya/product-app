...
export default function Productcard(props)
{
    ...
    return (
      ...
      <img src={data.imgUrl} className="card-img-top" alt={data.label} style={{width:215,height:180}}/>
        <div className="card-body">
          
                <h4>{data.label || "Name Not Available"}</h4>
                
                <h5>{data.origin || "Name Not Available"}&nbsp;
                <img src={data.isVeg} className="card-img-top" alt="Food Type" style={{width:25,height:18}}/></h5>
